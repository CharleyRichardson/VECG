...
class Helper:
    ...
    def load_multiple_datasets(datasets):
        ...
        for i, k in enumerate(datasets['name']):
            temp = tfds.load(k, split=[datasets['split']], shuffle_files=True, data_dir='/users/wadh6616/tensorflow_datasets/')
    ...
    def load_dataset(dataset):
        temp = tfds.load(dataset['name'],split=[dataset['split']], shuffle_files=True, data_dir='/users/wadh6616/tensorflow_datasets/')
